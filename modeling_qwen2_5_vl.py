    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if pixel_values is not None:
            ...
            image_embeds, attn_logits, attn_key = self.get_image_features(pixel_values, image_grid_thw)
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        def _expand_dict_for_generationumber_of_vision_tokensual(dict_to_expand):
        ...
        model_kwargs = _expand_dict_for_generationumber_of_vision_tokensual(model_kwargs)
